  ...
  return (
    <div>
      ...
      <main className="bg-base-100 text-base-content flex flex-col xl:flex-row justify-between items-center p-10">
        <div>
          <OBJViewer objUrl="/esp32.obj" mtlUrl="/esp32.mtl" width={400} height={500} scale={3} />
        </div>
        <div>
          <OBJViewer objUrl="/ADXL345.obj" mtlUrl="/ADXL345.mtl" width={400} height={500} scale={5} />
        </div>
        <div>
          <OBJViewer objUrl="/18650.obj" mtlUrl="/18650.mtl" width={400} height={500} scale={3} />
        </div>
      </main>
    </div>
